...
const ChartView: React.FC<ChartViewProps> = ({
  ...
  // Render Radar Chart
  useEffect(() => {
    if (!showRadarChart || !radarRef.current || !radarChartData) return;
    ...
    // const seriesDataset = reportNames.map(reportName => ({
    //   label: reportName,
    //   data: [
    //       radarChartData[reportName]["Environmental"] || 0,
    //       radarChartData[reportName]["Social"] || 0,
  ...
  return (
    <div className="space-y-6">
      ...
      {showRadarChart && <div ref={radarRef} className="w-full h-96" />}
